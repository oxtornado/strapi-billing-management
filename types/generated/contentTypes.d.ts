...
export interface ApiCajeroCajero extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    apellidoCajero: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    nombreCajero: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    turnoTrabajoCajero: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiClienteCliente extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    correoElectronicoCliente: Schema.Attribute.Email;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direccionCliente: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    telefonoCliente: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFacturaFactura extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    detalle_factura: Schema.Attribute.Relation<
      ...
      'api::detalle-factura.detalle-factura'
    >;
    fechaEmisionFactura: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::factura.factura'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    totalFactura: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vendedora: Schema.Attribute.Relation<
      'oneToOne',
      'api::vendedora.vendedora'
    >;
  };
}
...
export interface ApiVendedoraVendedora extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    apellidoVendedora: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    factura: Schema.Attribute.Relation<'oneToOne', 'api::factura.factura'>;
    ...
    > &
      Schema.Attribute.Private;
    nombreVendedora: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    turnoTrabajoVendedora: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::vendedora.vendedora': ApiVendedoraVendedora;
